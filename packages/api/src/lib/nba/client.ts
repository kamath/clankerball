/* ============================================================
   ...
   The API key never leaves the server (this package only ever runs in the
   backend Worker). Pure shapes + the distribution math live in ./model.
   ============================================================ */
import {
...
/** RequestInit plus Next.js' cache hint (this fetch runs in the Next runtime,
    but @repo/api is typed against plain fetch, so declare the extension). */
